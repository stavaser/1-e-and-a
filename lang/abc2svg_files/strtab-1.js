...
break
case C.GRACE:for(g=s.extra;g;g=g.next){if(!g.stemless)
g.ys=-10}
...
s.notes[m].shhd=o}},set_stems:function(of){var p_v,i,m,nt,n,bi,bn,strss,g,C=abc2svg.C,abc=this,s=abc.get_tsfirst(),strs=[],lstr=[]
