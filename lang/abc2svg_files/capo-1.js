...
abc2svg.capo={gch_build:function(of,s){var t,i,gch,gch2,i2,abc=this,p_v=abc.get_curvoice(),a_gch=s.a_gch
...
abc2svg.modules.hooks.push(abc2svg.capo.set_hooks);abc2svg.modules.capo.loaded=true
