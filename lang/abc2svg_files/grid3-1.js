...
return}
var abc=this,cfmt=abc.cfmt(),img=abc.get_img(),txt=s.text,font,font_cl,cls,w,ln,i,lines=[],cl=[],bars=[],cells=[],nr=0,nc=0,wc=0
...
y+=hr}
x=x0
for(i=0;i<=nc;i++){line+='M'+x.toFixed(1)+' 3v'+(hr*nr).toFixed(1)+'\n'
x+=wc}
line+='"/>\n'
line+=lc
y=3-font.size*.7
